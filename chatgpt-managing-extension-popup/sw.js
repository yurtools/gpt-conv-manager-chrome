...
async function fetchProjectConversationsPage(gizmoId, cursor) {
    ...
    const url = `https://chatgpt.com/backend-api/gizmos/${encodeURIComponent(gizmoId)}/conversations?cursor=${encodeURIComponent(c)}`;
    ...
    return json; // { items: [...], cursor: <string|null> }
}
